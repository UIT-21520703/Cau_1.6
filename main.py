...
st.header('Mô Hình')
st.markdown('Mô hình phân loại đã xây dựng kiến trúc base_v2 của [PhoBERT](%s).' % \
            'https://github.com/VinAIResearch/PhoBERT', unsafe_allow_html=True)

st.header('Dự Đoán Cảm Xúc')
st.text_input(label = 'Nhập một câu tiếng Việt:', value ='')

# Link web: https://21520703-cau1-6.streamlit.app/
